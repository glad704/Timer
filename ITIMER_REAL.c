...
int main(int argc,char* argv[])
{
	...
	/*The interval timer value returned by setitimer() should be identical to the timer value returned by getitimer().*/
	if(ovalue.it_interval.tv_sec != pvalue.it_interval.tv_sec || ovalue.it_interval.tv_usec != pvalue.it_interval.tv_usec || ovalue.it_value.tv_sec != pvalue.it_value.tv_sec || ovalue.it_value.tv_usec != pvalue.it_value.tv_usec)
	{
